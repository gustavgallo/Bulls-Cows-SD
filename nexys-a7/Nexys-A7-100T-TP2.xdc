...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets confirma_IBUF]
...
#7 segment display
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { DIGIT[7] }]; #IO_L24N_T3_A00_D16_14 Sch=ca A
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { DIGIT[6] }]; #IO_25_14 Sch=cb              B 
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { DIGIT[5] }]; #IO_25_15 Sch=cc              C
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { DIGIT[4] }]; #IO_L17P_T2_A26_15 Sch=cd     D
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { DIGIT[3] }]; #IO_L13P_T2_MRCC_14 Sch=ce    E
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { DIGIT[2] }]; #IO_L19P_T3_A10_D26_14 Sch=cf F
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { DIGIT[1] }]; #IO_L4P_T0_D04_14 Sch=cg      G
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { DIGIT[0] }]; #IO_L19N_T3_A21_VREF_15 Sch=dp DP IGNOREIIII
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { confirma }]; #IO_L4N_T0_D05_14 Sch=btnu
#set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { start_f }]; #IO_L12P_T1_MRCC_14 Sch=btnl
